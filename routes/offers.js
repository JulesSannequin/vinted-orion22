...
cloudinary.config({
  cloud_name: "dogbpccq2",
  api_key: "273997951228831",
  api_secret: "B13jzOym6_Crct0M2OWwr1gQvuk",
});
...
router.get("/offers", async (req, res) => {
  try {
    ...
    filtersObject.product_name = "tn";
    console.log(filtersObject);

    const offers = await Offer.find(filtersObject).select(
